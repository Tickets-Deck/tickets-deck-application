...
export class ApplicationError extends BaseApplicationError {
  ...
  /**
   * The error message for ~ Invalid credentials
   */
  static InvalidCredentials: IApplicationError = {
  ...
  /**
   * The error message for ~ User is blocked
   */
  static UserIsBlocked: IApplicationError = {
    Text: "User is blocked",
    Code: "USER_1019",
  };

  /**
   * The error message for ~ User is not verified
   */
  ...
  /**
   * The error message for ~ Invalid Ordered Ticket Ids
   */
  static InvalidOrderedTicketIds: IApplicationError = {
    Text: "Invalid Ordered Ticket Ids",
    Code: "TICKET_ORDER_1005",
  };
  ...
  /**
   * The error message for ~ Event Start Date Is Required
   */
  static EventStartDateIsRequired: IApplicationError = {
    Text: "Event start date is required",
    Code: "EVENT_1009",
  };

  /**
   * The error message for ~ Event End Date Is Required
   */
  static EventEndDateIsRequired: IApplicationError = {
    Text: "Event end date is required",
    Code: "EVENT_1010",
  };

  /**
   * The error message for ~ Invalid Event Date
   */
  static InvalidEventDate: IApplicationError = {
    Text: "Invalid event date",
    Code: "EVENT_1011",
  };

  /**
   * The error message for ~ Event Has Ended
   */
  static EventHasEnded: IApplicationError = {
    Text: "Event has ended",
    Code: "EVENT_1012",
  };

  /**
   * The error message for ~ Event Already Liked By User
   */
  static EventAlreadyLikedByUser: IApplicationError = {
    Text: "Event already liked by user",
    Code: "EVENT_1013",
  };

  /**
   * The error message for ~ Event Not Liked By User
   */
  static EventNotLikedByUser: IApplicationError = {
    Text: "Event not liked by user",
    Code: "EVENT_1014",
  };
  ...
  /**
   * The error message for ~ Invalid transaction reference
   */
  static InvalidTransactionReference: IApplicationError = {
    Text: "Invalid transaction reference",
    Code: "PAYMENT_1002",
  };

  /**
   * The error message for ~ Payment Not Verified
   */
  static PaymentNotVerified: IApplicationError = {
  ...
  /**
   * The error message for ~ Same bank account already exists
   */
  static BankAccountWithSameDetailsExists: IApplicationError = {
    Text: "Same bank account already exists",
    Code: "BANK_1006",
  };

  /**
   * The error message for ~ User already has a bank account
   */
  static UserAlreadyHasBankAccount: IApplicationError = {
    Text: "User already has a bank account",
    Code: "BANK_1007",
  };
  ...
  /**
   * The error message for ~ Coupon is not yet valid
   */
  static CouponIsNotYetValid: IApplicationError = {
    Text: "Coupon is not yet valid",
    Code: "COUPON_CODE_1009",
  };

  /**
   * The error message for ~ Coupon has already been used by this user
   */
  static CouponAlreadyUsedByUser: IApplicationError = {
    Text: "Coupon has already been used by this user",
    Code: "COUPON_CODE_1010",
  };

  /**
   * The error message for ~ Invalid coupon max usage
   */
  static InvalidCouponMaxUsage: IApplicationError = {
    Text: "Invalid coupon max usage",
    Code: "COUPON_CODE_1011",
  };
  ...
  /**
   * The error message for ~ Enquiry could not be submitted
   */
