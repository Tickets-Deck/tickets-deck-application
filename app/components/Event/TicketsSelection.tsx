    ...
    >
      ...
      <div className="flex sm:items-end justify-between my-4 flex-col items-start gap-1 sm:flex-row sm:gap-0">
        ...
        <div className="flex w-full md:w-auto justify-between md:justify-normal gap-4 md:gap-2 items-center">
          ...
          <button
            className="h-[3rem] w-[3rem] md:size-fit rounded-[2.5rem] cursor-pointer text-lg p-[0.65rem] hover:bg-failed-color [&_svg_path]:hover:!stroke-white border-none bg-white [&_svg]:size-6 text-black grid place-items-center"
