    ...
    return (
        <div>
            <div className="mb-8 [&_h3]:text-xl [&_h3]:font-normal [&_h3]:text-white">
                ...
                {
                    !isEventCreated &&
                    <span className="text-sm text-white/50">Event ID: {eventRequest?.eventId}</span>
                }
            </div>
            ...
            <div className="flex flex-col md:flex-row">
                <div className="flex flex-col w-full mr-8">
                    ...
                    <div className="flex flex-col mb-6">
                        ...
                        <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
                            <span>Location</span>
                            <p className="text-base [&_img]:w-[200px] [&_img]:rounded-lg [&_img]:mb-2 capitalize">{eventRequest?.venue}</p>
                        </div>
                        <div className={styles.infoRow}>
                            <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
                                <span>Starting on:</span>
                                <p className="text-base [&_img]:w-[200px] [&_img]:rounded-lg [&_img]:mb-2">{moment(eventRequest?.startDate).format("Do of MMM, YYYY")}</p>
                            </div>
                            <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
                                <span>Time</span>
                                <p className="text-base [&_img]:w-[200px] [&_img]:rounded-lg [&_img]:mb-2">{moment(eventRequest?.startDate).format("hh:mm a")}</p>
                            </div>
                        </div>
                        <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
                            ...
                            <p
                                ...
                                dangerouslySetInnerHTML={{ __html: eventRequest?.description as string }} />
                        </div>
                        <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
                            <span>Category</span>
                            <p className="text-base [&_img]:w-[200px] [&_img]:rounded-lg [&_img]:mb-2">
                                {eventCategories?.find(category => category.id === eventRequest?.categoryId)?.name}
                            </p>
                        </div>
                        <div className="flex flex-col mb-2 [&_span]:mb-1 [&_span]:text-sm [&_span]:text-text-grey">
