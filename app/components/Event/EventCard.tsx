...
const EventCard: FunctionComponent<EventCardProps> = ({
    ...
    return (
        <div
            className={`
          flex flex-col relative w-[18.75rem] overflow-x-auto snap-center md:w-full md:max-w-[35%] px-[10px] pt-[20px] pb-[10px] rounded-xl min-[520px]:overflow-hidden h-[300px] max-h-full bg-dark-grey-2
        ...
        >
            ...
            <div className='z-[2] h-32 [&_img]:object-center rounded-xl overflow-hidden relative after:bg-[linear-gradient(180deg,_rgba(0,0,0,0)_4.17%,_rgba(#000,_0.2)_100%)] after:size-full after:top-0 after:left-0 after:absolute after:opacity-100 after:pointer-events-none hover:after:opacity-0 [&_img]:hover:scale-110'>
                {event.isArchived ? (
            ...
            <div className='flex items-start z-[2]'>
                <div className='basis-[85%] w-[76%] flex flex-col gap-1'>
                    <h3 className='text-left max-w-full whitespace-nowrap text-ellipsis overflow-hidden text-sm font-Mona-Sans-Wide font-medium w-fit'>
                        {event.title}
                    </h3>
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='text-sm text-white opacity-80'>{event.time}</span>
                    </div>
            ...
            {consoleDisplay && eventHoldsToday ? (
                ...
                <div className='flex gap-1'>
                    ...
                    {event.isArchived ? (
                        ...
                        <Link
                            className='z-[2] primaryButton !w-full !justify-center hover:!bg-white [&_button]:hover:text-primary-color'
                            href={
                                consoleDisplay
                        ...
                        >
                            <button className='text-sm cursor-pointer bg-transparent text-white border-none outline-none'>
                                View details
                            </button>
                        </Link>
                    )}
