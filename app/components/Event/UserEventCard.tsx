...
const UserEventCard: FunctionComponent<UserEventCardProps> = ({
  event,
}): ReactElement => {
  ...
  return (
    <div
      className={`flex flex-col relative w-full overflow-x-auto snap-center md:w-full px-[10px] pt-[20px] pb-[10px] rounded-xl min-[520px]:overflow-hidden h-[300px] max-h-full bg-dark-grey-2`}
    >
      <div className="z-[2] h-32 w-full rounded-xl overflow-hidden mb-2 relative after:bg-[linear-gradient(180deg,_rgba(0,0,0,0)_4.17%,_rgba(#000,_0.2)_100%)] after:size-full after:top-0 after:left-0 after:absolute after:opacity-100 after:pointer-events-none hover:after:opacity-0 [&_img]:hover:scale-110 hover:brightness-110">
        {event.isArchived ? (
          ...
          <Link className="size-full" href={`/event/${event.id}`}>
            <Image
