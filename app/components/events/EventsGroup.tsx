...
const EventsGroup: FunctionComponent<EventsGroupProps> = ({
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 min-[1200px]:grid-cols-4 gap-4'
                ...
                >
                    {
                        ...
                        eventsData
                            .filter((event) =>
                                consoleDisplay ? event : forPastEvents ? new Date(event.startDate) < new Date() : new Date(event.startDate) >= new Date()
                            )
                            .map((event, index) => {
