...
const CreateEventProgressBar: FunctionComponent<CreateEventProgressBarProps> = (
    { eventCreationStage, setEventCreationStage, eventRequest }): ReactElement => {
    ...
    return (
        <div className={styles.progressBarContainer}>
            ...
            <div className={`${styles.stage} ${ticketDetailsIsCurrent ? styles.currentStage : ''} ${ticketDetailsIsDone ? styles.doneStage : ''} ${ticketDetailsIsUndone ? styles.unDoneStage : ''} `}
            ...
            <div className={`${styles.stage} ${reviewAndPublishIsCurrent ? styles.currentStage : ''} ${reviewAndPublishIsDone ? styles.doneStage : ''} ${reviewAndPublishIsUndone ? styles.unDoneStage : ''} `}
