...
const HeroSection: FunctionComponent<HeroSectionProps> = ({
  ...
  return (
    <>
      <section
        className={
          // appTheme == Theme.Light ? styles.heroSectionLightTheme : styles.heroSection
          " pt-[6.5rem] flex sectionPadding pb-[4.5rem] flex-col sm:flex-row sm:py-[4.5rem] gap-8 bg-dark-grey items-center relative"
        }
      >
        ...
        <div className='absolute size-full overflow-hidden top-0 left-0 opacity-10 mix-blend-hard-light [&_span]:absolute'>
          <span className='bg-[#29ffbf] -top-1/2 left-[-40%] blur-[200px] w-[765px] h-[392px] moveFirstAnimation'></span>
