...
const HeroSection: FunctionComponent<HeroSectionProps> = ({
  ...
  const nextHotEvent = events.find((e) =>
  ...
  return (
    <>
      <section
        className={
          "sectionPadding !pt-[6.5rem] !pb-[4.5rem] flex flex-col md:flex-row gap-8 bg-dark-grey items-center relative"
        }
      >
