...
const IntroSection: FunctionComponent<IntroSectionProps> = ({
  ...
  return (
    <section
      className={
        //  appTheme === Theme.Light ? styles.introSectionLightTheme : styles.introSection
        "sectionPadding md:!py-16 flex md:items-start md:flex-row justify-between bg-dark-grey text-white flex-col items-center gap-8 !py-[2.5rem]"
      }
    >
      <div className='flex w-full flex-col md:w-[45%]'>
        <span className='text-base font-normal text-primary-color-sub-50 bg-primary-color/30 w-fit px-2 py-4 rounded-[1.25rem] mb-4'>
          Who We Are
        </span>
