...
interface ContactDetailsModalProps {
  ...
  setContactDetails: Dispatch<
    SetStateAction<CustomerContactDetails | undefined>
  >;
...
const ContactDetailsModal: FunctionComponent<ContactDetailsModalProps> = ({
  ...
  const validateFields = () => {
    ...
    setContactDetails({
      ...(contactDetails as CustomerContactDetails),
      phone: `+234${contactDetails?.phone.replace(/^0/, "")}`,
    });
    ...
    >
      <div className='w-full max-w-full md:w-[400px] md:max-w-[400px] p-6 rounded-2xl bg-container-grey'>
        ...
        <div className='flex flex-col mb-3'>
          <p className='text-sm'>
            Please provide your contact details so we can reach you if there are
            any issues with your tickets.
          </p>
          <span className='text-sm text-white/40'>
            To avoid this step in the future, you can{" "}
            <Link
