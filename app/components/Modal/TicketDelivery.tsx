  ...
  return (
    <>
      {onDesktop && (
        ...
        >
          <div
            className={`flex flex-col sm:flex-row h-fit sm:p-6 sm:rounded-[1.25rem] sm:h-[90vh] w-full bg-dark-grey text-white gap-5  ${
            ...
            <div className='sm:basis-[65%] flex flex-col basis-full gap-6'>
                ...
                {ticketPricings.map((ticketPricing, index) => (
                  <div className='flex flex-col gap-1 w-full' key={index}>
                    ...
                    <input
                      tabIndex={1}
                      type='text'
                      className='w-fit rounded-[3.125rem] text-sm py-[0.8rem] px-[1.1rem] border-none outline-none bg-white placeholder:text-grey'
              ...
              <div className='flex flex-col gap-1 w-full sm:w-auto items-start sm:items-stretch'>
                ...
                <div className='flex sm:items-center gap-2 flex-col sm:flex-row items-start w-full sm:w-auto'>
                  <div className='sm:w-fit rounded-[3.125rem] text-sm py-[0.8rem] px-[1.1rem] outline-none bg-white placeholder:text-grey border-[0.188rem] min-w-[40%] p-0 pr-[12px] w-full flex sm:block'>
                    <input
                      className='sm:w-fit rounded-[3.125rem] text-sm py-[0.8rem] px-[1.1rem] border-none outline-none bg-white placeholder:text-grey bg-transparent w-full'
                      tabIndex={1}
                      type='text'
                      name='couponCode'
                      id='coupon'
                    ...
                    />
                    <button
                      className={`bg-dark-grey text-white py-[5px] px-[12px] rounded-[12px] text-xs ${
                        canCodeBeValidated ? "!bg-primary-color" : ""
                      }`}
                      style={
                        isValidating
                          ? {
