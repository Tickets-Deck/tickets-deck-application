...
const SubscriptionFormSection: FunctionComponent<
  ...
  return (
    <>
      ...
      >
        ...
        <button
          type='submit'
          className='primaryButton !w-full justify-center !min-w-[8.75rem] !py-3 !px-6 !h-full whitespace-nowrap !rounded-3xl !text-base'
      ...
      {emailMsg && (
        <span
          ...
          className={`${
            emailMsg.status === SubscriptionMsgStatus.Success
              ? "text-success-color"
              : "text-[#eb485b]"
