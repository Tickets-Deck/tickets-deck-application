  ...
  return (
    <nav
      className={`
        ...
        ${
          isScrolled
            ? "bg-black/90 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow-md supports-[backdrop-filter]:bg-black/60"
            : ""
        }
        `}
    >
      ...
      <div className="flex items-center gap-6 text-white text-sm">
        <ul className="border-r pr-6 border-grey list-none flex items-center gap-4 cursor-pointer">
          ...
          <Link href={ApplicationRoutes.PulseBanners}>
            <li className="hover:text-primary-color-sub">PulseCards</li>
          </Link>
