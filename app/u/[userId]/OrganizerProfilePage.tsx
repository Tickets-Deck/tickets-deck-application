                        ...
                        <Tabs defaultValue={Tab.Events} className="mt-6">
                            ...
                            <TabsContent value={Tab.Events} className="!mt-6 !space-y-8">
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <Link href={ApplicationRoutes.GeneralEvents} className="primaryButton mx-auto">Browse All Events</Link>
                                </div>
                            </TabsContent>
                            <TabsContent value={Tab.About} className="!mt-6 !space-y-8">
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">About the Organizer</h3>
                                    <p className={userInformation.bio ? "text-white" : "text-white/70"}>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        <Link
                                            ...
                                            <Icons.Mail /><span>{userInformation.email}</span>
                                        </Link>
                                        {
                                            ...
                                            <Link
                                                ...
                                                <Icons.Phone /><span>{userInformation.phone}</span>
                                            </Link>
                                        }
